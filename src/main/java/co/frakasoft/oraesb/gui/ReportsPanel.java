...
public class ReportsPanel extends javax.swing.JPanel {
    ...
    private void initMoreComponents() throws Exception {
        ...
        serviceBrowserPanel.getServiceBrowserTree().getSelectionModel().setSelectionMode(TreeSelectionModel.SINGLE_TREE_SELECTION);
    ...
    private void initComponents() {
        ...
        spltServReports.setTopComponent(serviceBrowserPanel);

        btngrpReports.add(rdbtnOperationTotalInstances);
        rdbtnOperationTotalInstances.setText("Instancias totales por operacion");

        btngrpReports.add(rdbtnOperationTotalErrorInstances);
        rdbtnOperationTotalErrorInstances.setText("Instancias totales con errores por operacion");
        rdbtnOperationTotalErrorInstances.setEnabled(false);

        btngrpReports.add(rdbtnDailyServiceInstances);
        rdbtnDailyServiceInstances.setText("Instancias por dia para servicio");

        btngrpReports.add(rdbtnDailyServiceErrorInstances);
        rdbtnDailyServiceErrorInstances.setText("Instancias por dia con error para servicio");
        rdbtnDailyServiceErrorInstances.setEnabled(false);

        btngrpReports.add(rdbtnErrorTypeCount);
        rdbtnErrorTypeCount.setText("Errores por tipo");

        btngrpReports.add(rdbtnDailyServiceInstancesFromSummary);
        rdbtnDailyServiceInstancesFromSummary.setText("Instancias por dia para servicio (tabla sumarizada)");
        rdbtnDailyServiceInstancesFromSummary.setEnabled(false);

        btngrpReports.add(rdbtnHourlyServiceInstancesFromSummary);
        rdbtnHourlyServiceInstancesFromSummary.setText("Instancias por hora para servicio (tabla sumarizada)");
        rdbtnHourlyServiceInstancesFromSummary.setEnabled(false);

        btngrpReports.add(rdbtnDailyServiceOKInstances);
        rdbtnDailyServiceOKInstances.setText("Instancias por dia para servicio");
        rdbtnDailyServiceOKInstances.setEnabled(false);

        jLabel1.setForeground(new java.awt.Color(0, 153, 0));
        jLabel1.setText("(instancias verdes)");
