 ...
 * @author esalaza
 */
public class BasicServiceGroupInfo extends BasicESBEntityInfo {

    private List<Object> serviceGroupsOrServices = new ArrayList<Object>();
    
    public BasicServiceGroupInfo() {
        super();
    }
    
    public BasicServiceGroupInfo(String id, String name, String description) {
